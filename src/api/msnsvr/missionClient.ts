...
import { PoiSearcher } from "@/api/gen/PoiLocator_pb";
...
export class MissionClient {
  ...
  private readonly poiClient: Client<typeof PoiSearcher>;
  ...
  constructor(
    ...
    this.poiClient = createClient(PoiSearcher, transport);
  ...
  // For CallID: The version should be "1.0.0.0",
  // the ClientID is your AppID text,
  // The transaction_id is only needed if you are inside a transaction,
  // and the context is usually blank.
  ...
  async startTransaction(
    ...
    console.log("startTransaction res: ", res);
