...
const opt = (raw: string): string | undefined =>
...
const ACTIONS: DebugAction[] = [
  ...
  },
  {
    ...
    name: "endTransaction",
    fields: [],
    run: () => missionClient.endTransaction(),
  },
  ...
  },
  {
    ...
    fields: [
      { key: "pointId", label: "pointId" },
      {
        key: "coordinate",
        label: "coordinate",
        placeholder: "N 36 07.00/W 86 40.00",
      },
    ],
  ...
  },
  {
    ...
    run: (v) =>
      missionClient.setPointAttribute(
        v.pointId,
        v.attributeId,
        v.attributeType,
        v.attributeValue,
  ...
  },
  {
    ...
    run: (v) =>
      missionClient.getCalcPointAttribute(
        v.pointId,
        v.calcPointId,
        v.attributeId,
      ),
  ...
  },
  {
    ...
    run: (v) =>
      missionClient.getEventAttribute(v.pointId, v.eventId, v.attributeId),
  },
];
    ...
    >
      <Box
        sx={{
          ...
          alignItems: "baseline",
          gap: 1,
          mb: action.fields.length ? 1.25 : 1,
        }}
      >
        <Typography
          sx={{
      ...
      >
        ...
        {elapsed != null && (
          <Typography sx={{ fontFamily: MONO, fontSize: 11, color: MUTED }}>
            {elapsed} ms
          </Typography>
        )}
      </Box>
...
const MsnSvrDebugPage = () => {
  ...
  const state = [
    ...
    { label: "transaction", value: missionClient.transactionId },
  ];
      ...
      >
        <Box>
          ...
          <Typography sx={{ fontSize: 13, color: MUTED }}>
            Calls go to the live gRPC service (dev: /api → :5000). Remove{" "}
            <code>?debug</code> from the URL to return to the app.
          </Typography>
        </Box>
              ...
              <Box key={s.label}>
                ...
                <Typography
                  sx={{
                    fontFamily: MONO,
                    fontSize: 13,
                    color: s.value ? colors.accent : FAINT,
                  }}
                >
                  {s.value || "—"}
                </Typography>
