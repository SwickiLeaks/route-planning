    ...
    <Stack spacing={1.5} sx={{ p: 0.5 }}>
      ...
      <Stack direction="row" spacing={2} useFlexGap sx={{ alignItems: 'center', flexWrap: 'wrap' }}>
        <ToggleButtonGroup
          exclusive
          value={layer}
          onChange={(_event, value: string | null) => value != null && setLayer(value)}
          aria-label="Base layer"
        >
          <ToggleButton value="map">Tog 1</ToggleButton>
          <ToggleButton value="ter">Tog 2</ToggleButton>
          <ToggleButton value="sat">Tog 3</ToggleButton>
        </ToggleButtonGroup>

        <TextField label="Sample Textfield" defaultValue="Sample Value" sx={{ width: '10rem' }} />
